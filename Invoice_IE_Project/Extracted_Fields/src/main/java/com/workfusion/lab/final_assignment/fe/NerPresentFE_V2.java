 ...
 * Assignment 1
 */
@FeatureName(NerPresentFE_V2.FEATURE_NAME)
public class NerPresentFE_V2<T extends Element> implements FeatureExtractor<T> {
     ...
     */
    public NerPresentFE_V2(String type) {
        this.nerType = type;
    }
